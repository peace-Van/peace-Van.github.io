...
The network was trained over 20 epochs using the *Adam* solver. The batch size was 256. Learning rate started at 0.001 and reduced to 0.0001 after 10 epochs. Validation was done at the end of each epoch.    
...
> The first feature which I call it damp-coldness basically represents (winter) temperature level. For two observations with similar temperature, the one with less aridity has a higher value. Hopefully someone could give this feature a better name. This feature mostly agrees with Köppen's criterion among the **A, C, D** major groups.    
