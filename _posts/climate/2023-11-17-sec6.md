...
Clustering result on $T=1.6$. This is the maximum temperature to have no singleton cluster. The result is similar to that of a high-level hierarchical clustering. Right-click for full image.   
