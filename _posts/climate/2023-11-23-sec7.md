...
> In the group summary table, temperature is in °C and precipitation is in millimeter (mm). The interval specifies the (0.05 - 0.95) quantile. Summer/winter represent the consecutive three months with highest/lowest mean temperature respectively. 
