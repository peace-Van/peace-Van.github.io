...
**Fsh** cold humid continental (taiga) climate, land coverage 10.89%. Compared with **Emk**, it shows a larger annual temperature range (colder winter and dryer summer) and less precipitation. The type may also be called the *boreal* climate due to its predominance over the boreal Siberia and northern Canada.  
