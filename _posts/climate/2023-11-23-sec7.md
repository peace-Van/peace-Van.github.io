...
**EW** arid temperate (semi-continental desert) climate, land coverage 1.58%. The climate is not truly temperate, just the winter thermal level falls into the temperate category. Similar to **Es**, most areas feature a hot and dry summer and a cool and rainy/snowy winter, but precipitation is more scarce. Exceptions are in the **CW**-locked area in Argentina, where some areas have a slightly summer-concentrated rainfall pattern. The **EW** type in Argentina is closely bordering on **CW**, just slightly more continental due to inland location or higher elevation.   
...
**Fm** subarctic semi-oceanic climate, land coverage 4.20%. A transitional type between **Emk** and **Gh**. Also transitional between **Ff** and **Fsk** on the continentality spectrum. This is the type with the highest damp-coldness.        

![Fsh](/assets/NN7/Fsh__.png)
**Fsh** cold humid continental climate, land coverage 10.89%. Compared with **Emk**, it shows a larger annual temperature range (colder winter and dryer summer) and less precipitation. The type may also be called the *boreal* climate due to its predominance over the boreal Siberia and northern Canada.  
